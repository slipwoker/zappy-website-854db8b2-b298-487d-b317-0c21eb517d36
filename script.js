(function() {
  ...
  function validateField(field) {
    if (field.hasAttribute('data-ignore')) return true;
    ...
    if (field.hasAttribute('minlength') && value !== '') {
      ...
      if (value.length < min) {
        showFieldError(field, getErrorMessage(field, 'minlength'));
        return false;
      }
    }
    if (field.hasAttribute('pattern') && value !== '') {
      ...
      if (!pattern.test(value)) {
        showFieldError(field, getErrorMessage(field, 'pattern'));
        return false;
      }
    }
    return true;
  ...
  function getErrorMessage(field, rule) {
    ...
    return field.getAttribute('data-error-' + rule) || messages[rule] || 'Invalid field.';
  }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '854db8b2-b298-487d-b317-0c21eb517d36',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '854db8b2-b298-487d-b317-0c21eb517d36';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '854db8b2-b298-487d-b317-0c21eb517d36';
